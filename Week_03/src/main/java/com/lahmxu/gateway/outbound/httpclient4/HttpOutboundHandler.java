package com.lahmxu.gateway.outbound.httpclient4;
...
public class HttpOutboundHandler {
    ...
    public HttpOutboundHandler(String backendUrl) {
        ...
        proxyService = new ThreadPoolExecutor(cores, cores, keepAliveTime, TimeUnit.MILLISECONDS, new ArrayBlockingQueue<>(queueSize), new NamedThreadFactory("proxyService"), rejectedExecutionHandler);
    ...
    public void handle(final FullHttpRequest fullHttpRequest, final ChannelHandlerContext ctx) {
        // 写死后端服务
        final String url = this.backendUrl + fullHttpRequest.getUri();
    ...
    private void handleResponse(final FullHttpRequest fullHttpRequest, final ChannelHandlerContext ctx, final HttpResponse endpointResponse) throws Exception {
        ...
        try {
            String value = "endpointResponse: " + this.backendUrl+fullHttpRequest.getUri();;
